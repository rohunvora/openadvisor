...
import { CheckCircle, Shield, Eye, Twitter, ArrowRight, Loader2 } from "lucide-react";
    ...
    <div className="min-h-screen bg-white">
      ...
      <header className="fixed top-0 w-full bg-white/80 backdrop-blur-md border-b border-gray-100 z-50">
        <div className="max-w-6xl mx-auto px-6 py-4 flex justify-between items-center">
          ...
          <nav className="flex items-center gap-6">
            ...
            <a href="https://twitter.com/OpenAdvisor" className="text-gray-600 hover:text-gray-900">Twitter</a>
            {loading ? (
      ...
      <section className="pt-32 pb-20 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
            Link your Twitter, showcase your advisor relationships, and build trust through radical transparency. 
            No more hidden deals or compliance fears.
          </p>
      ...
      <section className="py-20 px-6 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          <h3 className="text-3xl font-bold text-center mb-12">The Problem with Crypto Advisor Deals Today</h3>
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-xl shadow-sm">
              ...
              <p className="text-gray-600">
                KOLs fear SEC violations and FTC fines. Projects worry about unregistered securities. 
                Everyone operates in the shadows.
              </p>
            </div>
            <div className="bg-white p-8 rounded-xl shadow-sm">
              ...
              <p className="text-gray-600">
                Communities can&apos;t tell who&apos;s genuinely excited vs. who&apos;s paid. 
                Hidden advisor deals erode trust in the entire ecosystem.
              </p>
            </div>
            <div className="bg-white p-8 rounded-xl shadow-sm">
              ...
              <p className="text-gray-600">
                Deals happen through DMs, Telegram chats, and back-channels. 
                No standard process means endless negotiations and delays.
              </p>
            </div>
          </div>
        </div>
      ...
      <section id="how-it-works" className="py-20 px-6">
        <div className="max-w-6xl mx-auto">
          <h3 className="text-3xl font-bold text-center mb-12">How OpenAdvisor Works</h3>
          <div className="grid md:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm">
                Verify your identity with Twitter OAuth and sign with your Solana wallet
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm">
                Create a transparent advisor profile showing all your relationships
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm">
                Manually add your existing advisor relationships for transparency
              </p>
            </div>
            <div className="text-center opacity-50">
              ...
              <p className="text-gray-600 text-sm">
                <span className="text-yellow-600 font-medium">Coming Q1 2025:</span> Accept on-chain token grants with built-in vesting
              </p>
            </div>
          </div>
        </div>
      ...
      <section id="roadmap" className="py-20 px-6">
        <div className="max-w-4xl mx-auto">
          <h3 className="text-3xl font-bold text-center mb-12">Product Roadmap</h3>
          <div className="space-y-6">
            <div className="bg-green-50 border-2 border-green-200 p-6 rounded-xl">
              <div className="flex items-center gap-3 mb-2">
                <span className="bg-green-600 text-white px-3 py-1 rounded-full text-sm font-medium">LIVE NOW</span>
                <h4 className="text-xl font-semibold">Phase 1: KOL Profiles & Transparency</h4>
              </div>
            ...
            <div className="bg-blue-50 border-2 border-blue-200 p-6 rounded-xl">
              <div className="flex items-center gap-3 mb-2">
                <span className="bg-blue-600 text-white px-3 py-1 rounded-full text-sm font-medium">Q1 2025</span>
                <h4 className="text-xl font-semibold">Phase 2: On-Chain Token Grants</h4>
              </div>
              <ul className="text-gray-700 space-y-1 ml-6">
            ...
            <div className="bg-purple-50 border-2 border-purple-200 p-6 rounded-xl">
              <div className="flex items-center gap-3 mb-2">
                <span className="bg-purple-600 text-white px-3 py-1 rounded-full text-sm font-medium">Q2 2025</span>
                <h4 className="text-xl font-semibold">Phase 3: Compliance Automation</h4>
              </div>
              <ul className="text-gray-700 space-y-1 ml-6">
      ...
      <footer className="bg-gray-900 text-white py-12 px-6">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-gray-400 mb-6">Building trust through transparency in crypto</p>
          <div className="flex gap-6 justify-center">
            <a href="https://twitter.com/OpenAdvisor" className="text-gray-400 hover:text-white">Twitter</a>
            <a href="https://github.com/openadvisor" className="text-gray-400 hover:text-white">GitHub</a>
